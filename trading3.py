...
url_folder1 = "DB TRADING/titoli1" # Inserire il percorso della folder_1 #valori di oggi
url_folder2 = "DB TRADING/titoli2" # Inserire il percorso della folder_2 #valori di ieri
url_folder_result= "DB TRADING/risultati" # Inserire il percorso della folder_result
...
if not os.path.exists(url_folder1):
    os.makedirs(url_folder1)
if not os.path.exists(url_folder2):
    os.makedirs(url_folder2)
